            ...
            .via(evb).then([this,
                ...
                if (val.hasException()) {
                    ...
                    for (auto& code : result.get_failed_parts()) {
                        ...
                        } else if (code.get_code() == static_cast<int32_t>(nebula::ErrorCode::E_STORAGE_PART_ID_NOT_FOUND) ||
                                   code.get_code() == static_cast<int32_t>(nebula::ErrorCode::E_GRAPH_SPACE_ID_NOT_FOUND)) {
                            invalidLeader(spaceId, code.get_part_id());
                        } else {
                            // do nothing
                        }
